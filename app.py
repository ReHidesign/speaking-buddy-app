...
if api_key:
    # Session állapotok inicializálása
    ...
    def call_groq(prompt, system_instruction):
        ...
        full_instr = (
            ...
            "IF the student says 'HELP': Explain the grammar error in their last sentence. "
        ...
        try:
            ...
            return "*(Buddy looks puzzled)* I had a brief connection issue. Could you repeat that?"
        except: return "*(Buddy apologizes)* My brain stalled. Let's try again!"

    # --- SIDEBAR (A megmentett HELP kártyával) ---
    with st.sidebar:
    ...
    if not st.session_state.intro_done:
        ...
        st.write("Whether you want to debate, describe a picture, or just have a friendly chat, I'm ready!")
